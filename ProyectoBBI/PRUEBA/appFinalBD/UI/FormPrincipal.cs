    ...
    public partial class FormPrincipal : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (rbEmpresa.Checked)
            {
                ...
                else if ((string)cbxTransaccion.SelectedItem == "Eliminar")
                {
                    //FormEliminacion delete = new FormEliminacion();
                    //delete.infoTextBox("Empresa");

                    //this.Hide();
                    //delete.ShowDialog();
                    //this.Show();
                    MessageBox.Show("Usted no tiene los permisos requeridos para realizar esa accion", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
                else
                {
        ...
        private void btnBuscarFecha_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ha ocurrido un error interno", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
